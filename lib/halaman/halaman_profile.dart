...
import 'package:mobile/componen/profile/halaman_edit_profile.dart';

import '../componen/profil/pengaturan_item.dart';
import '../componen/profil/pengaturan_switch.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: PengaturanModel(
                title2: 'Voucher', svgurl: 'assets/icons/voucher.svg'),
          ),
          Container(
            decoration: BoxDecoration(
              border: Border(bottom: BorderSide(color: Colors.grey)),
          ...
          PengaturanModel(
              title2: 'Privacy', svgurl: 'assets/icons/privacy.svg'),
          SizedBox(
            height: 28,
          ),
          Container(
